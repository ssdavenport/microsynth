...
`end.post=c(14,16)` in the code above, instructing results to be calculated for
two different follow-up periods, ending at t=14 and t=16 respectively. One
results table will be calculated for each.

```{r, eval = TRUE, echo = FALSE}
a <- readRDS("../data/sea2mini.Rds")
summary(a)
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea2-min.png")
```
...
```{r, eval = TRUE, echo = FALSE}
sea3m <- readRDS("../data/sea3mini.Rds")
summary(sea3m)
```
...
```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea3a-min.png")
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea3b-min.png")
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea3c-min.png")
```
...
```{r, eval = TRUE, echo = FALSE}
sea4m <- readRDS("../data/sea4mini.Rds")
summary(sea4m)
```
...
```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea4a-min.png")
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea4b-min.png")
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea4c-min.png")
```
...
```{r, eval = TRUE, echo = FALSE}
sea5m <- readRDS("../data/sea5mini.Rds")
summary(sea5m)
```
...
```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea6c-min.png")
```
...
group of follow-up periods (`end.post=c(14,16)`) without having to re-calculate
weights.

```{r ex7, eval = FALSE, echo=TRUE}
...
```{r, eval = TRUE, echo = FALSE}
sea7m <- readRDS("../data/sea7mini.Rds")
sea7m
```
...
```{r, eval = TRUE, echo = FALSE}
sea8m <- readRDS("../data/sea8mini.Rds")
summary(sea8m)
```

```{r out.width = "100%", echo=F}
knitr::include_graphics("../data/sea8-min.png")
```
...
```{r, eval = TRUE, echo = FALSE}
sea9m <- readRDS("../data/sea9mini.Rds")
sea9m
```
