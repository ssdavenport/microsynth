...
library(microsynth)
library(knitr)
knitr::opts_chunk$set(message = FALSE, fig.height=3.6, fig.width=10)
```
...
```{r ex3, eval = TRUE, fig.show = "hold", fig.width = 6, fig.height = 7} 
...
```{r ex4, eval = TRUE, fig.show = "hold", fig.width = 6, fig.height = 7} 
...
```{r ex6, eval = TRUE, fig.show = "hold", fig.width = 6, fig.height = 7}
...
```{r ex8, eval = TRUE, fig.show = "hold", fig.width = 6, fig.height = 7}
...
```{r ex9results, eval = TRUE, fig.show = "hold", fig.width = 6, fig.height = 7}
