...
Note that `match.out = match.out`, `result.var = match.out`, 
`omnibus.var =match.out`, and `plot.var=match.out`. This means that the outcome 
...
# saveRDS(sea2, "../inst/extdata/sea2micro.rds") # one-time command to save RDS object
sea2 <- readRDS("../inst/extdata/sea2micro.rds")
summary(sea2)
```

TODO: add explainers about plot()
```{r}
plot(sea2)
```
...
```{r, eval = TRUE, echo = FALSE}
# saveRDS(sea3, "../inst/extdata/sea3micro.rds") # one-time command to save RDS object
sea3 <- readRDS("../inst/extdata/sea3micro.rds")
summary(sea3)
```
...
# saveRDS(sea4, "../inst/extdata/sea4micro.rds") # one-time command to save RDS object
sea4 <- readRDS("../inst/extdata/sea4micro.rds")
summary(sea4)
```
...
```{r, eval = TRUE, echo = FALSE}
# saveRDS(sea5, "../inst/extdata/sea5micro.rds") # one-time command to save RDS object
sea5 <- readRDS("../inst/extdata/sea5micro.rds")
summary(sea5)
```

TODO: swap examples 6 and 7 if must show results before plots?
...
```{r, eval = TRUE, echo = FALSE}
# saveRDS(sea7, "../inst/extdata/sea7micro.rds") # one-time command to save RDS object
sea6m <- readRDS("../inst/extdata/sea7micro.rds")
sea6m
```

### Example 7:  Plots only

If weights have already been calculated, then plot() can be used to 
...
```{r, eval = TRUE, echo = FALSE}
# saveRDS(sea8, "../inst/extdata/sea8micro.rds") # one-time command to save RDS object
...
```{r, eval = TRUE, echo = FALSE}
# saveRDS(sea9, "../inst/extdata/sea9micro.rds") # one-time command to save RDS object
