...
a <- readRDS("../inst/extdata/sea2mini.Rds")
summary(a)
```
...
```{r, eval = TRUE, echo = FALSE}
sea3m <- readRDS("../inst/extdata/sea3mini.Rds")
summary(sea3m)
```
...
```{r, eval = TRUE, echo = FALSE}
sea4m <- readRDS("../inst/extdata/sea4mini.Rds")
summary(sea4m)
```
...
```{r, eval = TRUE, echo = FALSE}
sea5m <- readRDS("../inst/extdata/sea5mini.Rds")
summary(sea5m)
```
...
```{r, eval = TRUE, echo = FALSE}
sea7m <- readRDS("../inst/extdata/sea7mini.Rds")
sea7m
```
...
```{r, eval = TRUE, echo = FALSE}
sea8m <- readRDS("../inst/extdata/sea8mini.Rds")
summary(sea8m)
```
...
```{r, eval = TRUE, echo = FALSE}
sea9m <- readRDS("../inst/extdata/sea9mini.Rds")
sea9m
```
